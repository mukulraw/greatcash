...
public class IncomeJunc extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.income_junction, container, false);
    ...
    private void setID(View view) {
        ...
        text_ReferID = view.findViewById(R.id.text_referId_value);
        progressBar = view.findViewById(R.id.progress);
        text_today = view.findViewById(R.id.text_price_today);
        text_yes = view.findViewById(R.id.text_price_Yes);
        text_week = view.findViewById(R.id.text_price_Week);
        text_month = view.findViewById(R.id.text_price_Month);
        text_year = view.findViewById(R.id.text_price_Year);
